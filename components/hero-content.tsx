  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      <div className="container text-center z-10 pointer-events-auto">
        ...
        >
          <TextReveal text="AKASH MISHRA" className="text-4xl md:text-6xl font-bold tracking-tight mb-2" delay={0.5} />
          <TextReveal
          ...
          <div className="flex flex-wrap gap-4 justify-center mt-4">
            <Button asChild size="lg" className="text-lg relative overflow-hidden group">
              <a href="#projects">
            ...
            <Button variant="outline" asChild size="lg" className="text-lg relative overflow-hidden group">
